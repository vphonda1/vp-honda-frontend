// ════════════════════════════════════════════════════════════════════════════
// VP Honda Service Worker v2.7.0
...
self.addEventListener('notificationclick', e => {
  ...
  e.waitUntil(
    clients.matchAll({ type:'window', includeUncontrolled:true }).then(async list => {
      ...
      // कोई window नहीं खुली — नया खोलें
      //
      // ⚠️ FIX v2.7.0: पहले सीधे `/reminders?rid=…` खोला जाता था. अगर host पर
      // SPA rewrite ठीक न हो तो browser वहीं का 404 पन्ना दिखा देता था और
      // पूरा app खुलता ही नहीं था (Vercel: "404 NOT_FOUND").
      //
      // अब हम हमेशा घर (/) खोलते हैं और असली जगह `#nav=` में साथ भेजते हैं.
      // "/" हर हाल में मौजूद है, इसलिए 404 कभी नहीं आ सकता. app खुलते ही
      // registerSW उसे पढ़कर React Router से सही page पर ले जाता है.
      const target = `${self.location.origin}/#nav=${encodeURIComponent(url)}`;
