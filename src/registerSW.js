...
export const registerServiceWorker = () => {
  ...
  window.addEventListener('load', async () => {
    try {
      ...
      // ⏱️ पहले हर 60 सेकंड update जाँच होती थी और कभी clear नहीं होती थी.
      // यह Vercel पर जाती है (Render पर नहीं), पर फिर भी बेकार थी.
      // अब 30 मिनट में एक बार, और सिर्फ़ तब जब tab सामने हो.
