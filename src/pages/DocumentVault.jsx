// ═══════════════════════════════════════════════════════════════════════════
// 🆕🆕🆕 DocumentVault.jsx — VERSION-2026-08-18-SAVE-TO-DISK 🆕🆕🆕
// ✅ नया 💾 बटन — चुनकर laptop की hard disk में save + compress-once
// ═══════════════════════════════════════════════════════════════════════════
...
export default function DocumentVault() {
  ...
  const saveSelectedToDisk = async (useFolderPicker) => {
    ...
    try {
      ...
      const cleanName = (savePick.folder?.name || 'documents').replace(/[\\/:*?"<>|]/g, '_');
      if (dirHandle) {
