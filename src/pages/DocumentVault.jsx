// ═══════════════════════════════════════════════════════════════════════════
// 🆕🆕🆕 DocumentVault.jsx — VERSION-2026-08-15-VECTOR-SHRINK 🆕🆕🆕
// ✅ एक ही PDF ≤200KB — text vector रहता है, सिर्फ अंदर की images छोटी होती हैं
// ═══════════════════════════════════════════════════════════════════════════
...
async function compressExistingPdf(bytes, d, onProgress) {
  ...
  // ── तरीका 2: पूरे pages को image बनाकर एक ही PDF (text थोड़ा नरम पर एक file) ──
  try {
    ...
    // ── तरीका 3: आखिरी सहारा — हर page की अलग file ──
    const files = [];
    for (let i = 0; i < pages.length; i++) {
      onProgress?.(i + 1, pages.length);
