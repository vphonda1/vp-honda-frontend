...
export default function DocumentVault() {
  ...
  useEffect(() => {
    loadDocuments();
    // Customer Management वाला ही रास्ता: पहले server, न मिले तो localStorage
  ...
  // ════════════════════════════════════════════════════════════════════════
  // "नया Document" के Customer Name खाने वाली सूची
  // ════════════════════════════════════════════════════════════════════════
  // ⚠️ यहाँ **Customer Management वाले ग्राहक** आने चाहिए — वे नहीं जिनके
  // document पहले से बन चुके हैं. (नया document तो उसी का बनेगा जिसका अभी
  // नहीं बना — इसलिए बने हुए वालों की सूची यहाँ बेकार है.)
  //
  // इसलिए वही रास्ता अपनाया गया है जो CustomerManagement.jsx अपनाता है:
  //     1. /api/customers
  //     2. न मिले तो localStorage 'sharedCustomerData'  ← असली 505 ग्राहक यहीं हैं
  //
  // (जिनके document बन चुके हैं उनकी सूची ऊपर वाली folder-खोज में है — वह
  //  अलग है और `docs` से बनती है. दोनों को मिलाना नहीं है.)
  ...
  // 1 अक्षर से ही सूची खुल जाती है (पहले 2 चाहिए थे), और खाना खाली हो पर
  // cursor अंदर हो तो पहले 8 ग्राहक दिख जाते हैं.
            ...
            <div style={{ display:'grid', gap:10 }}>
              ...
              <div ref={dropdownRef} style={{ position:'relative' }}>
                ...
                <input value={custSearch} onChange={e => handleCustNameChange(e.target.value)}
                  ...
                  placeholder={customerPool.length
                    ? `नाम लिखें — ${customerPool.length} ग्राहक में से चुनें`
                    : 'नाम — पहले Customer Management खोलें'}
