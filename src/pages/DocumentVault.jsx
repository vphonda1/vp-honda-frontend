// ═══════════════════════════════════════════════════════════════════════════
// 🆕🆕🆕 DocumentVault.jsx — VERSION-2026-08-14-MEMORY-FIX 🆕🆕🆕
// ✅ इस version में: photo upload memory error fix + Cloudinary का असली error message
// ═══════════════════════════════════════════════════════════════════════════
...
async function imageToPDF(d) {
  ...
  let imgBytes, mime;
  if (d.fileUrl && !d.fileData) {
    // Cloudinary URL → fetch → bytes
    ...
    mime = d.fileData.substring(5, d.fileData.indexOf(';'));
  }
