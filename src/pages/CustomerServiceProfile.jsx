  ...
  const saveData = async () => {
    ...
    try {
      ...
      try {
        ...
        // ⚠️ FIX: यहाँ `/api/customers/:id/service-data` पर POST होता था —
        // ऐसा endpoint backend में है ही नहीं, हमेशा 404 आता था. चूँकि यह
        // `.catch(()=>{})` में लिपटा था, गलती चुपचाप दबी रहती थी और सिर्फ़
        // बेकार में एक network call जाती थी. हटा दिया — localStorage में
        // save हो ही चुका है, अगली बार page खुलने पर sync हो जाएगा.
        setSaving(false);
