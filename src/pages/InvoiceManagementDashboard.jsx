...
const parseVPHondaInvoice = (text, filename) => {
  ...
  const DESC_MAP = {
    // ── Service parts (original) ──────────────────────────────────────────
    '08233-2MA-F1LG1': 'ENGINE OIL ILIN 900ML 5W30MA',
    '08233-2MAF1LG1':  'ENGINE OIL ILIN 900ML 5W30MA',
    '08233-2MB-F0LG1': 'ENGINE OIL 600ML 5W30MA',
    '15412-K0N-D01':   'FILTER COMP ENGINE OIL',
    '15412-K0N-DO1':   'FILTER COMP ENGINE OIL',
    '17220-K0N-D00':   'ELEMENT COMP AIR CLEANER',
    '17220-K0N-D0C':   'ELEMENT COMP AIR CLEANER',
    '17220-K0N-DOO':   'ELEMENT COMP AIR CLEANER',
    '17210-K0N-D00':   'ELEMENT AIR CLEANER',
    '17210-K0L-D00':   'ELEMENT AIR CLEANER',
    '17210-K3C-D10':   'ELEMENT AIR CLEANER',
    '17210-KVT-D00':   'ELEMENT AIR CLEANER',
    '17211-K14-901':   'ELEMENT COMP AIR CLEANER',
    '17211-KTE-651':   'ELEMENT COMP AIR CLEANER',
    ...
    '06455-KYJ-930':   'PAD SET FR', '06455-KYJ-940': 'PAD SET FR',
    '06455-K0N-D01':   'PAD SET FR', '06455-K44-D01': 'PAD SET FR',
    '06455-K0V-AG1':   'PAD SET FR BRAKE', '06455-K67-951': 'PAD SET FR',
    '06455-KPP-N02':   'PAD SET FR BRAKE',
    '06435-KYJ-930':   'SHOE SET RR BRAKE', '06435-K0N-D01': 'SHOE SET RR BRAKE',
    '06430-KWP-900':   'SHOE SET BRAKE', '06430-K3C-D10': 'SHOE SET BRAKE',
    '06410-K67-900':   'DAMPER SET WHEEL', '06410-KWS-901': 'DAMPER SET WHEEL',
    '42711-K0N-D01':   'TIRE RR', '42711-KYJ-901': 'TIRE RR',
    '22401-K0N-D01':   'CLUTCH CABLE',
    '22870-K0N-D00':   'CABLE COMP CLUTCH', '22870-K0N-601': 'CABLE COMP CLUTCH',
    ...
    '88210-K38-041ZA': 'MIRROR COMP R*NH1*', '88210-K38-941ZA': 'MIRROR COMP R*NH1*',
    '88210-K0P-D00ZA': 'MIRROR COMP L', '88220-K0P-D00ZA': 'MIRROR COMP R',
    '88220-K38-941ZA': 'MIRROR COMP L*NH1*',
    '50661-K0N-D00':   'RUBBER MAIN STEP', '50661-KYJ-900': 'RUBBER MAIN STEP',
    // ── Parts from Excel (parts.xlsx) ────────────────────────────────────
    '01721-K0L-D00':   'AIR FILTER AND SEAL KIT',
    '02212-K0N-A00':   'CLUTCH ASSY KIT', '02220-K0N-A00': 'CLUTCH PLATE KIT',
    '02380-K0N-D01':   'CHAIN SPROCKET KIT', '02380-K14-910': 'CHAIN SPROCKET KIT',
    '02380-KTE-P11':   'CHAIN SPROCKET KIT SHINE', '02380-KWB-601': 'CHAIN SPROCKET KIT',
    '06303-K0L-D00':   'BRACKET FR NUMBER PLATE',
    '070ST-KOL-008':   'DLC COUPLER',
    '08270-99903':     'BRAKE FLUID DOT-3',
    '08307-COM-A00':   'CUSHION OIL TYPE 2F',
    '09105-KTE-A00':   'WHEEL BEARING KIT REAR', '09105-KTE-A01': 'WHEEL BEARING KIT REAR',
    '09106-KTE-A01':   'WHEEL BEARING KIT FRONT',
    '11394-K0N-D00':   'GASKET R CRANKCASE COVER', '11394-K3C-D11': 'GASKET R COVER',
    '12391-K0N-D01':   'GASKET COMP HEAD COVER', '12391-K0P-D01': 'GASKET COMP CYLINDER HEAD',
    '12391-K0V-A01':   'GASKET COMP HEAD COVER', '12391-KRM-840': 'GASKET HEAD COVER',
    '12391-KWP-900':   'GASKET HEAD COVER',
    '16707-K0L-D01':   'FILTER SET', '16707-K0Y-D01': 'FILTER SET',
    '17611-KFN-850':   'CUSHION FR FUEL TANK',
    '17910-K0L-601':   'CABLE COMP A THROTTLE', '17910-K0N-601': 'CABLE COMP A THROTTLE',
    '17910-K0N-D81':   'CABLE COMP A THROTTLE', '17910-K0P-661': 'CABLE COMP A THROTTLE',
    '17910-K0P-671':   'CABLE COMP A THROTTLE', '17910-K0P-DA1': 'CABLE COMP A THROTTLE',
    '17910-K0V-B01':   'CABLE COMP A THROTTLE', '17910-K3C-D11': 'CABLE COMP A THROTTLE',
    '17910-KTE-911':   'CABLE COMP THROTTLE',
    '17920-K0L-601':   'CABLE COMP B THROTTLE', '17920-K0N-D01': 'CABLE COMP B THROTTLE',
    '17920-K0N-D81':   'CABLE COMP B THROTTLE', '17920-K0P-661': 'CABLE COMP B THROTTLE',
    '17920-K0P-671':   'CABLE COMP B THROTTLE', '17920-K0P-DA1': 'CABLE COMP B THROTTLE',
    '17920-K0V-A01':   'CABLE COMP B THROTTLE', '17920-K0V-B01': 'CABLE COMP B THROTTLE',
    '17920-K3C-D11':   'CABLE COMP B THROTTLE', '17920-KWP-305': 'CABLE SET THROTTLE',
    '18355-KON-DJO':   'COVER MUFFLER',
    '21395-K0L-D00':   'GASKET TRANSMISSION CASE',
    '22100-KWP-D01':   'OUTER COMP CLUTCH',
    '22120-K0N-D01':   'CENTER CLUTCH', '22120-K0V-A02': 'CENTER CLUTCH',
    '22123-K0P-D00':   'ROLLER SET WEIGHT',
    '22201-K0V-A02':   'DISK CLUTCH FRICTION', '22201-K55-602': 'DISK CLUTCH FRICTION',
    '22202-K0V-B01':   'DISK B CLUTCH FRICTION',
    '22321-K0V-A02':   'PLATE CLUTCH', '22321-KWB-601': 'PLATE CLUTCH',
    '22355-K0N-D01':   'PLATE CLUTCH PRESSURE', '22355-K55-602': 'PLATE CLUTCH PRESSURE',
    '22535-K0P-D00':   'WEIGHT SET CLUTCH',
    '23100-K0L-D01':   'BELT DRIVE', '23100-K0P-D01': 'BELT DRIVE',
    '23100-K24-901':   'BELT DRIVE', '23100-K24-903': 'BELT DRIVE',
    '23411-K0P-600':   'SHAFT DRIVE', '23421-K0P-D00': 'SHAFT COUNTER',
    '23422-K0P-600':   'GEAR COUNTER', '23430-K0P-DA1': 'GEAR COMP FINAL',
    '30400-K0V-A21':   'ENGINE CONTROL UNIT',
    '30700-K0L-D01':   'CAP ASSY NOISE SUPPRESSOR', '30700-K0V-A01': 'CAP ASSY NOISE SUPPRESSOR',
    '31906-KTE-911':   'PLUG SPARK (UR6DC)', '31917-KWP-D01': 'SPARK PLUG MR7C-9N',
    '32100-K0V-BK0':   'HARNESS WIRE',
    '33400-K0N-D01':   'LIGHT ASSY WINKER R FR', '33400-KWS-901': 'WINKER ASSY R FR',
    '33450-K0N-D01':   'LIGHT ASSY WINKER L FR', '33450-KWS-901': 'WINKER ASSY L FR',
    '33600-K0N-D01':   'LIGHT ASSY WINKER R RR', '33600-K0V-A01': 'WINKER ASSY R RR',
    '33650-K0N-D01':   'LIGHT ASSY WINKER L RR', '33650-K21-901': 'WINKER ASSY L RR',
    '33703-K0V-A01':   'COMP TAIL LIGHT', '33705-K0V-AC1': 'SOCKET COMP',
    '34901-KVN-971':   'BULB HEAD LIGHT (HS1)', '34904-KTE-910': 'BULB WINKER LIGHT (AMBER)',
    '34906-GBG-750':   'BULB TAIL LIGHT', '34909-KVE-900': 'BULB WEDGE BASE',
    '34930-KWA-930':   'BULB AMBER RR (12V 10W)',
    '35010-K0L-D00':   'KEY SET', '35010-K0V-AC1': 'KEY SET',
    '35130-K0L-D01':   'SW UNIT ENG STOP START', '35180-KWP-901': 'SW UNIT HORN',
    '35330-KYJ-901':   'SW COMP FR LEVER', '35340-KSP-B51': 'SW ASSY FR STOP',
    '35750-KWS-901':   'CONTACT NEUTRAL SWITCH',
    '38110-K0L-D01':   'HORN COMP', '38110-K0N-D81': 'HORN COMP',
    '38220-SNA-A51':   'BLADE FUSE 15A', '38221-SNA-A61': 'BLADE FUSE 20A',
    '43450-K0P-D01':   'CABLE COMP RR BRAKE', '43450-KWP-G12': 'CABLE COMP RR BRAKE',
    '43455-KSP-900':   'JOINT BRAKE ARM',
    '44820-KTE-911':   'GEAR SET SPEEDOMETER', '44820-KWP-900': 'GEAR SET SPEEDOMETER',
    '44830-K14-900':   'CABLE COMP SPEEDOMETER', '44830-KVT-940': 'CABLE COMP SPEEDOMETER',
    '45251-K0N-D01':   'DISK FR BRAKE',
    '45440-K86-D32':   'CABLE COMP LH FR BRAKE', '45440-KWP-G12': 'CABLE COMP LH FR BRAKE',
    '45450-K86-D32':   'CABLE COMP RH FR BRAKE', '45450-KWP-910': 'CABLE COMP FR BRAKE',
    '45450-KWP-G12':   'CABLE COMP RH FR BRAKE',
    '50281-KON-D00':   'GROMMET SHROUD',
    '50530-K0N-D00':   'BAR COMP SIDE STAND', '50530-K0N-D20': 'BAR COMP SIDE STAND',
    '50610-K0N-D00':   'BAR COMP STEP',
    '51490-K0L-D02':   'SEAL SET FR FORK', '51490-K14-C01': 'SEAL SET FR FORK',
    '51490-K23-902':   'SEAL SET FR FORK', '51490-KRM-852': 'SEAL SET FR FORK',
    '51490-KST-305':   'SEAL SET FR FORK', '51490-KTE-602': 'SEAL SET FR FORK',
    '51490-KWL-003':   'SEAL SET FR FORK',
    '53105-KRC-900':   'END STEERING HANDLE',
    '53140-K0N-D00':   'GRIP COMP THROTTLE', '53140-K38-940': 'GRIP COMP THROTTLE',
    '53146-KRB-901':   'GRIP COMP THROTTLE',
    '53172-K0P-DA0':   'BRACKET L BRAKE LEVER', '53172-KWP-910': 'BRACKET L BRAKE LEVER',
    '53175-K0N0-D01':  'LEVER COMP R HANDLE', '53175-KVG-A21': 'LEVER R STEERING HANDLE',
    '53175-KWP-D00':   'LEVER R STEERING HANDLE',
    '53178-K0N-D00':   'LEVER COMP L HANDLE', '53178-KWP-D00': 'LEVER L STEERING HANDLE',
    '53209-GAH-000':   'CLIP HEAD LIGHT', '53250-K0P-D00ZA': 'COVER COMP HANDLE RR',
    '61200-K0V-AJ0ZG': 'SET ILLUS FR COWL', '61220-K0V-A00ZA': 'SET ILLUS WINDSCREEN',
    '61300-K3C-D10ZD': 'SET ILLUS FR VISOR', '61306-K1K-D50ZC': 'GARNISH L FR',
    '61310-K0N-D00ZE': 'SET ILLUS R FR GARNISH', '61310-K0N-DU0ZD': 'SET ILLUS R FR GARNISH',
    '61311-K0N-DZ0':   'COVER H L RR', '61311-KTE-D80': 'COVER HEAD LIGHT RR',
    '67111-K0V-A00':   'GARNISH SCREEN', '77156-K0N-D01': 'CABLE COMP SEAT LOCK',
    '80101-K0V-AJ0':   'FENDER REAR',
    '83551-300-000':   'GROMMET AIR CLEANER', '83551-376-00': 'GROMMET SIDE COVER',
    '90103-K38-940':   'BOLT ADAPTER 10MM', '90104-KT2-000': 'SCREW SPL 6X14',
    '90108-KZL-860':   'BOLT SIDE STAND PIVOT',
    '90116-SO0-003':   'CLIP BPR SEAL', '90116-SP0-003': 'CLIP BPR SEAL',
    '90201-MW3-620':   'NUT HEX 10MM',
    '91003-K0P-D01':   'BEARING BALL RADIAL 6301', '91006-KWP-G31': 'BEARING BALL RADIAL 6201',
    '91007-KWP-G32':   'BEARING BALL RADIAL 6202', '91009-K0J-N01': 'BEARING BALL RADIAL 60/22',
    '91104-KCW-880':   'BEARING BALL RADIAL 6204',
    '91202-K0V-A01':   'OIL SEAL 12X22X5', '91203-K0V-A01': 'OIL SEAL 20X32X6',
    '91210-K0N-D01':   'OIL SEAL 22.3X32X6',
    '95015-42000':     'NUT ADJUST', '98200-40750': 'FUSE 7.5A (MINI)',
    'CEAT-90/100-10':  'SCOTTY TYRE',
    'P05':             'NO. PLATE COVER', 'P05 (B)': 'NO. PLATE COVER',
    'CONSUM':          'CONSUMABLE CHARGES', 'LABOUR': 'LABOUR CHARGES',
  };
  ...
  if (items.length === 0) {
    const KNOWN_PARTS = Object.keys(DESC_MAP).filter(k => k !== 'P05' && k !== 'P05 (B)' && k !== 'CONSUM' && k !== 'LABOUR' && k !== 'CEAT-90/100-10');
...
export default function InvoiceManagementDashboard() {
  ...
  // एक बार तुरंत चलती है. यही सबसे बड़ी बचत है — service सो पाती है.
    intervalRef.current = visibleInterval(fn, 180000);   // 30s → 3 मिनट + hidden पर रुके
    return () => { window.removeEventListener('storage', fn); intervalRef.current?.(); };
  }, []);
  ...
  const processPDFFiles = async (files, importType = 'service') => {
    if (!files.length) return;
    setImporting(true);
    setProgress({ current:0, total:files.length });
    const existing = getLS('invoices',[]);
    const added = [], errors = [], skipped = [];

    // ✅ FIX 3: duplicate check — existing invoice numbers (don't overwrite)
    const existingNos = new Set(existing.map(i => String(i.invoiceNumber || i.id || '')));
    ...
    for (let i=0; i<files.length; i++) {
      ...
      try {
        ...
        // ✅ FIX 3: skip if already exists
        const invNo = String(parsed.invoiceNumber || '');
        if (invNo && existingNos.has(invNo)) {
          skipped.push(file.name);
          console.log(`⏭️ Skip duplicate: ${invNo}`);
          continue;
        }

        // ✅ FIX 2: force invoiceType from import button (vehicle or service)
        // Only override if parser couldn't determine type clearly
        if (importType === 'vehicle') {
          parsed.invoiceType = 'vehicle';
        }
        // For service: keep parser's detected type (it knows 1st Service, 2nd Service etc.)

        // ✅ FIX 4: ensure parts price not missing — recalculate if 0
        parsed.items = (parsed.items || []).map(item => {
          if (!item.totalAmount && item.unitPrice && item.quantity) {
            item.totalAmount = +(item.unitPrice * item.quantity).toFixed(2);
          }
          if (!item.gstAmount && item.totalAmount && item.gstRate) {
            item.gstAmount = +(item.totalAmount * item.gstRate / 100).toFixed(2);
          }
          return item;
        });

        // Recalculate totals if items were fixed
        if (parsed.items.length > 0 && parsed.totals.totalAmount === 0) {
          const subtotal = parsed.items.reduce((s, it) => s + (it.totalAmount || 0), 0);
          const gstAmount = parsed.items.reduce((s, it) => s + (it.gstAmount || 0), 0);
          parsed.totals.subtotal = +subtotal.toFixed(2);
          parsed.totals.gstAmount = +gstAmount.toFixed(2);
          parsed.totals.totalAmount = +(subtotal + gstAmount).toFixed(2);
        }

        existingNos.add(invNo); // prevent duplicate within same batch
        added.push(parsed);
      } catch (err) {
        ...
        added.push({
          ...
          invoiceType: importType, // ✅ FIX 2: type even on error fallback
    ...
    loadInvoices();
    const skipMsg = skipped.length ? ` | ⏭️ ${skipped.length} already exist (skipped)` : '';
    setMessage(errors.length
      ? `✅ ${added.length-errors.length} import हुए | ⚠️ ${errors.length} errors${skipMsg}`
      : `✅ ${added.length} PDFs import! Customer, Parts, Amount, Vehicle सब extract हो गया।${skipMsg}`);
