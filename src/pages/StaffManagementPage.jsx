...
<div style="font-family:'Segoe UI',Arial,sans-serif;background:#f1f5f9;margin:0;padding:0;">
    ...
    <div style="padding:10px 14px;">
      <table style="width:100%;font-size:11px;border-collapse:collapse;">
        ...
        <tr>
          ...
          <td style="padding:3px 0;">${staff.department || staff.position || '—'}</td>
        </tr>
        <tr>
  ...
  <div style="margin:6px 18px 0;display:flex;gap:10px;align-items:stretch;">
    <!-- ⚠️ "नियम याद दिलाएं" वाला हिस्सा हटा दिया गया — जुर्माने की सूची
         salary slip पर छापना पेशेवर नहीं लगता. TeamLease जैसी असली slip में
         भी ऐसा कुछ नहीं होता. उसकी जगह वह जानकारी जो slip पर होनी चाहिए. -->
    <div style="flex:1.8;background:white;border-radius:10px;padding:8px 12px;box-shadow:0 3px 12px rgba(0,0,0,0.07);border-left:4px solid #16a34a;">
      <div style="font-size:9px;font-weight:700;color:#15803d;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:5px;">Amount in Words</div>
      <div style="font-size:11.5px;font-weight:700;color:#0f172a;line-height:1.5;">${amountWords}</div>
      <table style="width:100%;font-size:8.5px;color:#64748b;border-collapse:collapse;margin-top:7px;border-top:1px solid #f1f5f9;padding-top:4px;">
        <tr>
          <td style="padding:3px 6px 0 0;">Working Days</td><td style="padding:3px 10px 0 0;font-weight:700;color:#334155;">${wDays}</td>
          <td style="padding:3px 6px 0 0;">Paid Days</td><td style="padding:3px 10px 0 0;font-weight:700;color:#334155;">${present}</td>
          <td style="padding:3px 6px 0 0;">LOP</td><td style="padding:3px 0 0 0;font-weight:700;color:#334155;">${absent}</td>
        </tr>
        <tr>
          <td style="padding:2px 6px 0 0;">Per Day</td><td style="padding:2px 10px 0 0;font-weight:700;color:#334155;">${fmt(perDay)}</td>
          <td style="padding:2px 6px 0 0;">Pay Mode</td><td style="padding:2px 10px 0 0;font-weight:700;color:#334155;">${staff.bankName ? 'Bank' : 'Cash'}</td>
          <td style="padding:2px 6px 0 0;">Slip No.</td><td style="padding:2px 0 0 0;font-weight:700;color:#334155;">${slipNo}</td>
        </tr>
      </table>
