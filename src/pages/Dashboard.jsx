    ...
    <div style={{ background:COLORS.bg, minHeight:'100vh', color:COLORS.text }}>
      ...
      <main style={{ padding:'24px 28px', maxWidth:1400, margin:'0 auto' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(200px, 1fr))', gap:14, marginBottom:24 }}>
          <StatCard icon={Users}        label="Total Customers"   value={stats.totalCustomers}                              color={COLORS.primary}  onClick={() => navigate('/customers')}/>
          ...
          <StatCard icon={Car}          label="Pending RTO"       value={stats.pendingRTO}                                  color={COLORS.warning}  onClick={() => navigate('/customers')}/>
          <StatCard icon={Shield}       label="Pending Insurance" value={stats.pendingInsurance}                            color={COLORS.cyan}     onClick={() => navigate('/customers')}/>
          <StatCard icon={Wrench}       label="Pending Jobs"      value={stats.pendingJobs}                                 color={COLORS.danger}   onClick={() => navigate('/job-cards')}/>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'2fr 1fr', gap:14 }}>
          ...
          <div style={cardStyle}>
            ...
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:8 }}>
              <QuickBtn icon={Plus}          label="New Customer" onClick={() => navigate('/new-customers')}        color={COLORS.primary}/>
              <QuickBtn icon={FileText}      label="New Invoice"  onClick={() => navigate('/invoice-management')}  color={COLORS.accent}/>
              <QuickBtn icon={Wrench}        label="Job Card"     onClick={() => navigate('/job-cards')}             color={COLORS.warning}/>
              <QuickBtn icon={FileText}      label="Quotation"    onClick={() => navigate('/quotation')}          color={COLORS.purple}/>
