...
export default function CustomerServiceDataManager() {
  ...
  // एक बार तुरंत चलती है. यही सबसे बड़ी बचत है — service सो पाती है.
    intervalRef.current = visibleInterval(loadAllData, 180000); // 15s → 3 मिनट + hidden पर रुके
    return () => { window.removeEventListener('storage', onStorage); intervalRef.current?.(); };
  }, []);
