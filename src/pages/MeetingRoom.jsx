  ...
  useEffect(() => {
    ...
    if (window.JitsiMeetExternalAPI) {
      ...
      if (existing) {
        ...
        cleanupLoad = () => { try { existing.removeEventListener('load', initJitsi); } catch {} };
      } else {
    ...
    return () => {
      disposed = true;
      // ⚠️ script के 'load' listener को भी हटाएँ — वरना meeting बार-बार
      // खोलने पर listeners जमा होते रहते थे (memory leak)
      cleanupLoad?.();
