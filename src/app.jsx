...
import NotifBanner from './components/NotifBanner';  // removed from render — kept for optional future use
    ...
    const handleMsg = (event) => {
      if (event.data?.type === 'NAVIGATE') {
        ...
        if (url) {
          ...
          if (current !== url) {
            window.location.href = url;  // full reload so RemindersPage reads ?focus= param
          }
        }
      }
    };
